...
// foxglove_bridge 3.x uses the SDK protocol name. Its message format remains
// compatible with the open-source v1 client used by this Studio build.
FoxgloveClient.SUPPORTED_SUBPROTOCOL = "foxglove.sdk.v1";
